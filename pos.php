						...
						<div class="row">
							<div class="col-md-12">
								<div class="table-responsive-sm">
									<table class="table table-striped table-bordered border-warning table-primary table-hover" id="list">
										<colgroup>
											<col width="25%">
											<col width="10%">
											<col width="25%">
								...
								<div class="modal-body">
									<div class="container-fluid">
										...
										<div class="form-group">
											...
											<select name="paymode" id="paymode" class="custom-select browser-default select2" required>
												<option value=""></option>
