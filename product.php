					...
					<div class="card-body">
						<form action="" id="manage-product">
							...
							<div class="form-group">
								...
								<select name="product_name" id="product_name" class="custom-select browser-default" onchange="updateImage()">
							...
							<div class="form-group" style="display: none;">
								<label class="control-label">Bill Price</label>
								<input type="number" step="any" class="form-control" name="b_price">
							</div>
							<div class="form-group">
								<label class="control-label">Last Price</label>
